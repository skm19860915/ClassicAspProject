...
Redirect = ""
TemplateFileName = "AdminEmailTemplateList.html"
Set CCSEvents = CreateObject("Scripting.Dictionary")
PathToCurrentPage = "./"
FileName = "AdminEmailTemplateList.asp"
PathToRoot = "./"
...
' Events
%>
<!-- #INCLUDE VIRTUAL="AdminEmailTemplateList_events.asp" -->
<%
BindEvents
...
'EmailTemplate1 Operation Method @39-54C1EB4E
    Sub Operation()
        ...
        If FormSubmitted Then
            ...
            End If
        End If
        Redirect = "AdminEmailTemplateList.asp"
        If Validate() Then
            If PressedButton = "Button_DoSearch" Then
                If NOT Button_DoSearch.OnClick() Then
                    Redirect = ""
                Else
                    Redirect = "AdminEmailTemplateList.asp?" & CCGetQueryString("Form", Array(PressedButton, "ccsForm", "Button_DoSearch.x", "Button_DoSearch.y", "Button_DoSearch"))
                End If
            End If
        Else
            Redirect = ""
...
'EmailTemplate Variables @2-2D20F538
    ...
    Dim Alt_EmailTemplateNickname
    Dim Alt_EmailTemplateSection
...
'EmailTemplate Class_Initialize Event @2-6F756013
    Private Sub Class_Initialize()
        ...
        Set Sorter_EmailNickname = CCCreateSorter("Sorter_EmailNickname", Me, FileName)
        ...
        Set EmailTemplateNickname = CCCreateControl(ccsLabel, "EmailTemplateNickname", Empty, ccsText, Empty, CCGetRequestParam("EmailTemplateNickname", ccsGet))
        Set EmailTemplateSection = CCCreateControl(ccsLabel, "EmailTemplateSection", Empty, ccsText, Empty, CCGetRequestParam("EmailTemplateSection", ccsGet))
        ...
        Set Alt_EmailTemplateNickname = CCCreateControl(ccsLabel, "Alt_EmailTemplateNickname", Empty, ccsText, Empty, CCGetRequestParam("Alt_EmailTemplateNickname", ccsGet))
        Set Alt_EmailTemplateSection = CCCreateControl(ccsLabel, "Alt_EmailTemplateSection", Empty, ccsText, Empty, CCGetRequestParam("Alt_EmailTemplateSection", ccsGet))
...
'EmailTemplate Show Method @2-231D1D5D
    Sub Show(Tpl)
        Dim HasNext
        If NOT Visible Then Exit Sub
        ...
        Set StaticControls = CCCreateCollection(TemplateBlock, Null, ccsParseOverwrite, _
            Array(Link1, Sorter_EmailID, Sorter_EmailNickname, Sorter_EmailName, Sorter_EmailToAddress, Sorter_EmailFromAddress, Sorter_EmailSubject, Navigator, EmailTemplate_TotalRecords))
            
            Link1.Parameters = CCGetQueryString("QueryString", Array("ccsForm"))
            Link1.Page = "AdminEmailTemplateEdit.asp"
            Navigator.SetDataSource Recordset
            
        Set RowControls = CCCreateCollection(RowBlock, Null, ccsParseAccumulate, _
            Array(EmailTemplateID, EmailTemplateNickname, EmailTemplateSection, EmailTemplateName, EmailTemplateToAddress, EmailTemplateFromAddress, EmailTemplateSubject, EmailTemplateEmailType, EmailTemplateUserLastUpdateBy, EmailTemplateUserLastUpdateDateTime))
        Set AltRowControls = CCCreateCollection(AltRowBlock, RowBlock, ccsParseAccumulate, _
            Array(Alt_EmailTemplateID, Alt_EmailTemplateNickname, Alt_EmailTemplateSection, Alt_EmailTemplateName, Alt_EmailTemplateToAddress, Alt_EmailTemplateFromAddress, Alt_EmailTemplateSubject, Alt_EmailTemplateEmailType, Alt_EmailTemplateUserLastUpdateBy, Alt_EmailTemplateUserLastUpdateDateTime))
            ...
            Do While ForceIteration
                ...
                If RenderAltRow Then
                    If HasNext Then
                        ...
                        Alt_EmailTemplateID.Parameters = CCGetQueryString("QueryString", Array("ccsForm"))
                        ...
                        Alt_EmailTemplateID.Page = "AdminEmailTemplateEdit.asp"
                        Alt_EmailTemplateNickname.Value = Recordset.Fields("Alt_EmailTemplateNickname")
                        Alt_EmailTemplateSection.Value = Recordset.Fields("Alt_EmailTemplateSection")
...
'DataSource Variables @2-E09DD52F
    ...
    Public Alt_EmailTemplateNickname
    Public Alt_EmailTemplateSection
...
'DataSource Class_Initialize Event @2-EC8212FA
    Private Sub Class_Initialize()
        ...
        Set Alt_EmailTemplateNickname = CCCreateField("Alt_EmailTemplateNickname", "EmailTemplateNickname", ccsText, Empty, Recordset)
        Set Alt_EmailTemplateSection = CCCreateField("Alt_EmailTemplateSection", "EmailTemplateSection", ccsText, Empty, Recordset)
        ...
        Fields.AddFields Array(EmailTemplateID,  EmailTemplateID_param1,  EmailTemplateNickname,  EmailTemplateSection,  EmailTemplateName,  EmailTemplateToAddress,  EmailTemplateFromAddress, _
             EmailTemplateSubject,  EmailTemplateEmailType,  EmailTemplateUserLastUpdateBy,  EmailTemplateUserLastUpdateDateTime,  Alt_EmailTemplateID,  Alt_EmailTemplateID_param1,  Alt_EmailTemplateNickname,  Alt_EmailTemplateSection, _
             Alt_EmailTemplateName,  Alt_EmailTemplateToAddress,  Alt_EmailTemplateFromAddress,  Alt_EmailTemplateSubject,  Alt_EmailTemplateEmailType,  Alt_EmailTemplateUserLastUpdateBy,  Alt_EmailTemplateUserLastUpdateDateTime)
        Set Parameters = Server.CreateObject("Scripting.Dictionary")
        Set WhereParameters = Nothing
        Orders = Array( _ 
            Array("Sorter_EmailID", "EmailTemplateID", ""), _
            Array("Sorter_EmailNickname", "EmailTemplateNickname", ""), _
