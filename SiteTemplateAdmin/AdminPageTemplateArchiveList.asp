...
Redirect = ""
TemplateFileName = "AdminPageTemplateArchiveList.html"
Set CCSEvents = CreateObject("Scripting.Dictionary")
PathToCurrentPage = "./"
FileName = "AdminPageTemplateArchiveList.asp"
PathToRoot = "./"
...
'PageTemplateSearch Operation Method @3-B264C36E
    Sub Operation()
        ...
        If Validate() Then
            If PressedButton = "Button_DoSearch" Then
                If NOT Button_DoSearch.OnClick() Then
                    Redirect = ""
                Else
                    Redirect = "AdminPageTemplateArchiveList.asp?" & CCGetQueryString("Form", Array(PressedButton, "ccsForm", "Button_DoSearch.x", "Button_DoSearch.y", "Button_DoSearch"))
                End If
            End If
        Else
            Redirect = ""
...
'PageTemplate Variables @21-0E288C9B
...
'PageTemplate Class_Initialize Event @21-9AF00B7E
    Private Sub Class_Initialize()
        ...
        Visible = (CCSecurityAccessCheck("50;40") = "success")
...
'PageTemplate Show Method @21-73A19BD8
    Sub Show(Tpl)
        Dim HasNext
        If NOT Visible Then Exit Sub
        ...
        With DataSource
            ...
            .Parameters("expr65") = "PageTemplateArchive"
            .Parameters("exprKey67") = "PageTemplateID"
        End With
        ...
        Set StaticControls = CCCreateCollection(TemplateBlock, Null, ccsParseOverwrite, _
            Array(Sorter_PageTemplateID, Sorter_PageTemplateName, Sorter_PageTemplateNickname, Sorter_PageTemplatePageType, Navigator))
            ...
            Do While ForceIteration Or HasNext
                If RenderAltRow Then
                    If HasNext Then
                        ...
                        Alt_PageTemplateID.Parameters = CCAddParam(Alt_PageTemplateID.Parameters, "PageTemplateUserLastUpdateDateTime", Recordset.Fields("Alt_PageTemplateID_param2"))
                        Alt_PageTemplateID.Page = "AdminPageTemplateArchiveView.asp"
                ...
                Else
                    If HasNext Then
                        ...
                        PageTemplateID.Parameters = CCAddParam(PageTemplateID.Parameters, "PageTemplateUserLastUpdateDateTime", Recordset.Fields("PageTemplateID_param2"))
                        PageTemplateID.Page = "AdminPageTemplateArchiveView.asp"
...
'DataSource Variables @21-91AC1653
    ...
    Public Alt_PageTemplateID_param2
...
'DataSource Class_Initialize Event @21-69360E34
    Private Sub Class_Initialize()
        ...
        Set PageTemplateID_param2 = CCCreateField("PageTemplateID_param2", "PageTemplateUserLastUpdateDateTime", ccsText, Empty, Recordset)
        ...
        Set Alt_PageTemplateID_param2 = CCCreateField("Alt_PageTemplateID_param2", "PageTemplateUserLastUpdateDateTime", ccsText, Empty, Recordset)
        ...
        Fields.AddFields Array(PageTemplateID,  PageTemplateID_param1,  PageTemplateID_param2,  PageTemplateName,  PageTemplateNickname,  PageTemplatePageType,  PageTemplateUserLastUpdateBy, _
             PageTemplateUserLastUpdateDateTime,  Alt_PageTemplateID,  Alt_PageTemplateID_param1,  Alt_PageTemplateID_param2,  Alt_PageTemplateName,  Alt_PageTemplateNickname,  Alt_PageTemplatePageType,  Alt_PageTemplateUserLastUpdateBy,  Alt_PageTemplateUserLastUpdateDateTime)
        ...
        Orders = Array( _ 
            ...
            Array("Sorter_PageTemplatePageType", "PageTemplatePageType", ""))

        SQL = "sp_getPageTemplateArchiveList;1"
    End Sub
...
'BuildTableWhere Method @21-98E5A92F
    Public Sub BuildTableWhere()
    End Sub
'End BuildTableWhere Method

'Open Method @21-5BAE0F38
    Function Open(Cmd)
        Errors.Clear
        ...
        Cmd.CommandType = dsProcedure
        Set Cmd.Parameters.ParameterSources = Me.Parameters 
        CCSEventResult = CCRaiseEvent(CCSEvents, "BeforeBuildSelect", Me)
        With Cmd
            .CommandType = dsProcedure
            .SP = "sp_getPageTemplateArchiveList;1"
            .CommandParameters = Array( _
                Array("@SiteID", "sesSiteID", adInteger, adParamInput, 0, 0, 10, -1, Empty), _
                Array("@searchString", "urls_PageTemplateSearchString", adVarChar, adParamInput, 8000, 0, 10, Empty, Empty), _
                Array("@tableName", "expr65", adVarChar, adParamInput, 8000, 0, 10, Empty, Empty))
                'Array("@orderBy", "exprKey67", adBSTR, adParamInput, 0, 0, 0, Empty, Empty))
        End With
